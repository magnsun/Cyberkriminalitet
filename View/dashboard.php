    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item"><a class="nav-link active" href="/backend/routes.php?page=dashboard">Dashboard</a></li>
                ...
                <li class="nav-item"><a class="nav-link" href="/backend/routes.php?page=brugeradministration">Brugeradministration</a></li>
            </ul>
